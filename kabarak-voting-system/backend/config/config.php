...
/**
 * Get the base URL path for assets.
 * This handles both XAMPP/Apache and PHP built-in server scenarios.
 */
function kvs_base_path(): string
{
    // Get the script filename relative to document root
    ...
    // If index.php is in root, return empty (absolute paths work)
    if ($scriptDir === '/' || $scriptDir === '.') {
        return '';
    }
    
    // Return the directory path (e.g., /kabarak-voting-system)
