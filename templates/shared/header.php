...
$cssFiles = [$basePath . '/assets/css/style.css'];
if ($role === 'admin') {
    $cssFiles[] = $basePath . '/assets/css/admin.css';
} elseif ($role === 'student') {
    $cssFiles[] = $basePath . '/assets/css/user.css';
}
...
<header class="app-header">
    ...
    <nav class="app-header__nav">
        <?php if ($role === 'admin'): ?>
            <a href="<?= htmlspecialchars($basePath . '/index.php', ENT_QUOTES, 'UTF-8') ?>" class="nav-link" data-nav="dashboard">Dashboard</a>
            <a href="<?= htmlspecialchars($basePath . '/index.php?page=elections', ENT_QUOTES, 'UTF-8') ?>" class="nav-link" data-nav="elections">Elections</a>
            <a href="<?= htmlspecialchars($basePath . '/index.php?page=blockchain', ENT_QUOTES, 'UTF-8') ?>" class="nav-link" data-nav="blockchain">Blockchain</a>
        <?php elseif ($role === 'student'): ?>
            <a href="<?= htmlspecialchars($basePath . '/index.php', ENT_QUOTES, 'UTF-8') ?>" class="nav-link" data-nav="home">Home</a>
            <a href="<?= htmlspecialchars($basePath . '/index.php?page=vote', ENT_QUOTES, 'UTF-8') ?>" class="nav-link" data-nav="vote">Vote</a>
            <a href="<?= htmlspecialchars($basePath . '/index.php?page=stats', ENT_QUOTES, 'UTF-8') ?>" class="nav-link" data-nav="stats">Live Stats</a>
        <?php endif; ?>
    </nav>
